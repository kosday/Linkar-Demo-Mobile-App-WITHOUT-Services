    ...
    public class ItemDataStore
    {
        ...
        public async Task<IEnumerable<Item>> GetItemsAsync(bool forceRefresh = false)
        {
            ...
            if (forceRefresh)
            {
                ...
                try
                {
                    ...
                    string lkstring = App.linkarClt.Select_Text("LK.ITEMS", "", "BY CODE", "", "", new SelectOptions(false, false, 10, 1, true), DATAFORMAT_TYPE.MV, "", 0);
        ...
        public async Task<Item> GetItemAsync(string id)
        {
            ...
            if (id != null)
            {
                ...
                try
                {
                    string lkstring = App.linkarClt.Read_Text("LK.ITEMS", id, "", new ReadOptions(true), DATAFORMAT_TYPE.MV, "", 0);
